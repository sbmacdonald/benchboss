...
<div class="row-fluid" style="padding:0px 0px 10px 0px;">
  <div class="span4 bubble-fieldset" >
    <form action="goalieAdmin-divs.cgi" method="POST" class="form-horizontal">
...
<div class="row-fluid" style="padding:0px 0px 10px 0px;">
  <div class="span4 bubble-fieldset btn-pad-top" >
    <form action="goalieAdmin-divs.cgi" method="POST" class="form-inline form-indent" style="padding-left:0px;">
      ...
      <div style="padding-left:15px;">
        <div class="input-prepend">
          ...
          <select class="input-small" name="goalieNoResponseEmailDay">${goalieNoResponseEmailSelection}</select>
          </div>
          <b>at:</b>
